...
p2 <- ggpubr::ggarrange(Fig_2_b + labs(x = "Scale", y = "Transgressiver overyielding"),
                        Fig_2_d + labs(x = "Scale", y = "Transgressiver overyielding"), ncol = 2, nrow = 1, widths = c(1, 1),
                  labels = c("A", "B"),
                  font.label = list(size = 10, color = "black", face = "bold", family = NULL))

ggsave(filename = here("figures/fig_Z.pdf"), 
       plot = p2, width = 18, height = 7.5, units = "cm", dpi = 450)
...
ggsave(plot = Fig3, filename = here("figures", "Fig_U.pdf"), 
       width = 18, height = 8.5, units = "cm", dpi = 450)
```
