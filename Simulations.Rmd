...
To generate the subplots for Figure S2, the `Scenario` Variable (line 135) has to be set to `1` and `2` respectively, and the code from line 135 to line 420 has to be run with these valules respectively. Figure S2 is the assembled and exported from teh same script as Figure 2. 
...
Choosing Scenarion = 2 & 1 produces the subplots for supplemantary Figure S1
