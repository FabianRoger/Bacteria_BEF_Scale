...
It excludes strain "a" which has strong negtaive effects on the other strains in mixtures. 
To run the code and prodcue Fig S7, set `Sens_analysis = TRUE`
...
Data %>% 
  ...
  labs(y = "production", x = "habitat", colour = "strain")
